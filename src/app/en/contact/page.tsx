    ...
    <main className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-center max-w-3xl mx-auto mb-12">
          The Naftali Gan team will be happy to answer any questions. Fill out the form or use the contact details below.
        </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Flower Street, Tel Aviv, Israel</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Sunday-Thursday: 8:00AM-7:00PM</p>
                  <p className="text-gray-600">Friday: 8:00AM-2:00PM</p>
